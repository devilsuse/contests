package com.nano.hacker.contest.weekofcode21;

import java.util.Scanner;

/**
 * There are two kangaroos on an x-axis ready to jump in the positive direction
 * (i.e, toward positive infinity). The first kangaroo starts at location and
 * moves at a rate of meters per jump. The second kangaroo starts at location
 * and moves at a rate of meters per jump. Given the starting locations and
